...
use op_editor_ui::widgets::{
    CanvasViewport, GitPanel, LocalePicker, PaintCx, ShapePicker, TopBar, Widget, TOP_BAR_HEIGHT,
};
...
impl WidgetHostNative {
    ...
    pub fn paint(
        ...
        // 5-8.6. The per-panel arms — PropertyPanel through the reference
        // card — live in `paint_panel_arms`, in this order: that order IS
        // their z-order, and the press ladder mirrors it in reverse.
        self.paint_panel_arms(
            frame,
            viewport_width,
            viewport_height,
            presenting,
