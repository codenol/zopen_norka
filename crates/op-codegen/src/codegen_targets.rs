...
impl Codegen for Html {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        ...
        out.push_str(&format!("<!-- Generated by {} — codegen::Html -->\n", op_editor_core::PRODUCT_NAME));
...
impl Codegen for Vue {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        let mut out = String::new();
        out.push_str(&format!("<!-- Generated by {} — codegen::Vue -->\n", op_editor_core::PRODUCT_NAME));
...
impl Codegen for Svelte {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        let mut out = String::new();
        out.push_str(&format!("<!-- Generated by {} — codegen::Svelte -->\n", op_editor_core::PRODUCT_NAME));
...
impl Codegen for React {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        let mut out = String::new();
        out.push_str(&format!("// Generated by {} — codegen::React\n", op_editor_core::PRODUCT_NAME));
...
impl Codegen for Flutter {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        let mut out = String::new();
        out.push_str(&format!("// Generated by {} — codegen::Flutter\n", op_editor_core::PRODUCT_NAME));
...
impl Codegen for SwiftUi {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        let mut out = String::new();
        out.push_str(&format!("// Generated by {} — codegen::SwiftUi\n", op_editor_core::PRODUCT_NAME));
...
impl Codegen for Compose {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        let mut out = String::new();
        out.push_str(&format!("// Generated by {} — codegen::Compose\n", op_editor_core::PRODUCT_NAME));
...
impl Codegen for ReactNative {
    ...
    fn generate(&self, doc: &PenDocument) -> String {
        let mut out = String::new();
        out.push_str(&format!("// Generated by {} — codegen::ReactNative\n", op_editor_core::PRODUCT_NAME));
        out.push_str("import React from 'react';\n");
