...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "comments.panel.empty" => "Пока нет комментариев к этому документу",
        ...
        "comments.pin.arm" => "Комментарий к элементу",
        "comments.pin.armed" => "Нажмите на элемент, чтобы оставить комментарий",
