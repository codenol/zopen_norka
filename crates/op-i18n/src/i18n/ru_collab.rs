...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "collab.topbar.unavailable" => "Совместная работа здесь недоступна",
        ...
        "collab.join.signInUnavailable" => "Для совместной работы нужен аккаунт, а войти здесь нельзя.",
        ...
        "account.entry.errorTooManyAttempts" => "Слишком много неудачных попыток. Повторите через {{seconds}} секунд.",
        "account.entry.errorTooManyAttemptsUnstated" => "Слишком много неудачных попыток. Подождите немного, прежде чем повторить.",
        ...
        "share.row.anyoneWithLink.caption.admin" => "Все, кто войдёт, смогут править документ и делиться им.",
        "share.row.anyoneWithLink.caption.editor" => "Все, кто войдёт, смогут править этот документ.",
        "share.row.anyoneWithLink.caption.commenter" => "Все, кто войдёт, смогут комментировать и приглашать.",
        "share.row.anyoneWithLink.caption.viewer" => "Все, кто войдёт, смогут только смотреть документ.",
        ...
        "share.invite.refused.unknownAccount" => "Аккаунта с именем {{account}} нет. Проверьте написание или пригласите по email.",
        "share.invite.refused.shareLimit" => "Документ уже открыт {{limit}} аккаунтам. Удалите одного, чтобы добавить нового.",
        ...
        "section.state.notReadable" => "Вы не можете прочитать этот документ аналитики",
        "section.state.checkFailed" => "Не удалось проверить документ аналитики",
        ...
        "settings.agents.roles" => "Роли моделей",
        "settings.agents.rolesBuilder" => "Собирает",
        "settings.agents.rolesVerifier" => "Проверяет",
        _ => return None,
    })
}
