...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "comments.panel.empty" => "Chưa có bình luận nào cho tài liệu này",
        ...
        "comments.pin.arm" => "Bình luận về một phần tử",
        "comments.pin.armed" => "Nhấp vào một phần tử để bình luận",
