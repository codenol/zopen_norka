...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "collab.topbar.unavailable" => "Cộng tác không khả dụng ở đây",
        ...
        "collab.join.signInUnavailable" => "Cộng tác cần một tài khoản, và ở đây không có cách đăng nhập.",
        ...
        "account.entry.errorTooManyAttempts" => "Quá nhiều lần thử thất bại. Hãy thử lại sau {{seconds}} giây.",
        "account.entry.errorTooManyAttemptsUnstated" => "Quá nhiều lần thử thất bại. Hãy đợi một lúc rồi thử lại.",
        ...
        "share.row.anyoneWithLink.caption.admin" => "Ai đăng nhập được cũng có thể sửa tài liệu này và chia sẻ lại.",
        "share.row.anyoneWithLink.caption.editor" => "Ai đăng nhập được cũng có thể sửa tài liệu này.",
        "share.row.anyoneWithLink.caption.commenter" => "Ai đăng nhập được cũng có thể bình luận và mời.",
        "share.row.anyoneWithLink.caption.viewer" => "Ai đăng nhập được cũng chỉ có thể xem tài liệu này.",
        ...
        "share.invite.refused.unknownAccount" => "Không có tài khoản nào tên {{account}}. Kiểm tra lại chính tả hoặc mời bằng email.",
        "share.invite.refused.shareLimit" => "Tài liệu này đã được chia sẻ với {{limit}} tài khoản. Hãy xoá một tài khoản để thêm tài khoản mới.",
        ...
        "section.state.notReadable" => "Bạn không thể đọc tài liệu phân tích này",
        "section.state.checkFailed" => "Không thể kiểm tra tài liệu phân tích",
        ...
        "settings.agents.roles" => "Vai trò",
        "settings.agents.rolesBuilder" => "Tạo",
        "settings.agents.rolesVerifier" => "Kiểm tra",
        _ => return None,
    })
}
