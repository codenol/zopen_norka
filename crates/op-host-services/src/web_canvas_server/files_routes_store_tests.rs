...
// The stale-autosave guard's own test lives beside this file (issue #247):
// it was the line that pushed this one past the 800-line cap.
#[cfg(test)]
#[path = "files_routes_stale_save_tests.rs"]
mod stale_save_tests;
