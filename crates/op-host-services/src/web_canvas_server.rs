...
// The request dispatch table that used to sit here — every route arm of
// `handle_web_canvas_request` — is now the sibling `request_dispatch.rs`;
// see the `mod` and re-export blocks at the bottom of this spine.
...
pub use request_dispatch::handle_web_canvas_request;
pub use run_loop::*;
pub use section_rights::SubjectAction;
