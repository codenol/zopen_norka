...
/// The schema's history, in its own file: it only ever grows, and the rule that
/// governs it (append, never edit) is about the list rather than this store.
mod document_db_migrations;

use document_db_migrations::{Migration, MIGRATIONS};
